# AI bootstrap: Obsidian documentation (next-eldesquite)

You are helping maintain internal documentation for this repository.

## Scope

- Vault root: `wiki/obsidian-eldesquite` (relative to repo root).
- API catalog: Bruno collection `wiki/bruno-eldesquite` — mirror `app/api/**` route handlers.
